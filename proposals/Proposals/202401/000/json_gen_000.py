...
data_to_save = \
    {
        ...
        "Objective":
            ...
            This will aid in understanding how, over time, women’s access to civil liberties, participation in society, and representation in politics have changed. 
        ...
        "Dataset":
            """
            The current datasets, Women’s Empowerment Index and Women’s Universal Right to Vote, come from Ourworldindata.
            ...
            A combination of the Women Civil Liberties Index, Women Civil Society Participation Index, and Women Political Participation Index, the Women’s Political Empowerment Index provides a quantitative analysis of women’s rights and aids in understanding the development or destruction of democracy equal civil rights is seen as a necessity to transition to democracy. 
            ...
            The Women's Universal Right to Vote dataset tracks whether women’s suffrage is present in a country using a system of 0 and 1 (0 for no, 1 for yes). 
        ...
        "Timeline":
	        ...
	        Feb. 19: Mapping Women’s Empowerment Index over time
