...
<!-- category breakup -->
```{r}
quantiles <- quantile(wemp100yr$wpei, probs = c(1/3, 2/3), na.rm = TRUE)
quantiles
mapwemp100yr[, 'category'] = NA 
mapwemp100yr[, 'categoryvalue'] = NA 
#emerging wpei < 0.238 developing 0.238 < wpei < 0.474 established wpei > 0.474
mapwemp100yr$category <- as.factor(ifelse(mapwemp100yr$wpei<0.238, 'emerging',
                                  ifelse(mapwemp100yr$wpei>0.238 & mapwemp100yr$wpei<0.474, 'developing', 
                                  ifelse(mapwemp100yr$wpei>0.474, 'established', 'none')))) 
mapwemp100yr$categoryvalue <- as.numeric(ifelse(mapwemp100yr$wpei<0.238, 1, 
                                         ifelse(mapwemp100yr$wpei>0.238 & mapwemp100yr$wpei<0.474, 2, 
                                         ifelse(mapwemp100yr$wpei>0.474, 3, 0))))
```
<!-- category maps -->
```{r message=FALSE, warning=FALSE}
