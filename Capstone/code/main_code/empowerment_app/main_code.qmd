...
#GRAPH
ggplot(grouped_combined, aes(x = as.factor(decade), y = count, fill = category)) +
...
allworld <- ggplot() +
  ...
  # Define the manual color scale for the outlines
...
# Loading your data (assuming 'mapwemp100yr' and 'map' are already loaded)
years_data <- list(
