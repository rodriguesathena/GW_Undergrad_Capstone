...
#1900 map
basemap + geom_map(data = vote1900, map = vote1900, aes(long, lat, map_id = region), fill = "purple")
#1950 map
basemap + geom_map(data = vote1950, map = vote1950, aes(long, lat, map_id = region), fill = "purple")
#2000 map
basemap + geom_map(data = vote2000, map = vote2000, aes(long, lat, map_id = region), fill = "purple")
```
