...
#1900 map
basemap + geom_map(data = mapvote1900, map = mapvote1900, aes(long, lat, map_id = region), fill = "purple")
#1950 map
basemap + geom_map(data = mapvote1950, map = mapvote1900, aes(long, lat, map_id = region), fill = "purple")
#2000 map
basemap + geom_map(data = mapvote2000, map = mapvote2000, aes(long, lat, map_id = region), fill = "purple")
```
